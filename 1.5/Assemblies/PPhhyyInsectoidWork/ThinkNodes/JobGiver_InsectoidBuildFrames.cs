...
{
    public class JobGiver_InsectoidBuildFrames : ThinkNode
    {
        public override ThinkResult TryIssueJobPackage(Pawn pawn, JobIssueParams jobParams)
        {
            // The vanilla workgiver that we're gonna use to tell the insect to work
            WorkGiver_ConstructFinishFrames workgiver = PPhhyyWorkGiverDefOfs.ConstructFinishFrames.Worker as WorkGiver_ConstructFinishFrames;

...
{
    public class JobGiver_InsectoidDeliverResourcesToFrames : ThinkNode
    {
        public override ThinkResult TryIssueJobPackage(Pawn pawn, JobIssueParams jobParams)
        {
            // The vanilla workgiver that we're gonna use to tell the insect to work
            WorkGiver_ConstructDeliverResourcesToFrames workgiver = PPhhyyWorkGiverDefOfs.ConstructDeliverResourcesToFrames.Worker as WorkGiver_ConstructDeliverResourcesToFrames;
